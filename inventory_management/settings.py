...
ALLOWED_HOSTS = [RENDER_EXTERNAL_HOSTNAME, 'localhost', '127.0.0.1'] if RENDER_EXTERNAL_HOSTNAME else []
...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic',  # Add this ABOVE 'django.contrib.staticfiles'
